...
ui <- fluidPage(
  ...
  titlePanel(title = div(img(src="dihi.png", width = "25%"),"Geriatric Surgical Risk Calculator"),
             windowTitle = "Geriatric Surgical Risk Calculator"),
...
server <- function(input, output){
  ...
  coef_table <- readRDS("data/model_coefs_posh.rds")
